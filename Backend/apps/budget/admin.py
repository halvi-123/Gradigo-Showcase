...
class TransactionAdmin(admin.ModelAdmin):
    ...
    search_fields = ("name", "budget__user__username", "budget__user__email", "category__category_name")
    ordering = ("-date",)


@admin.register(SavingsGoal)
class SavingsGoalAdmin(admin.ModelAdmin):
    list_display = ("id", "user", "name", "current_amount", "target_amount", "target_date")
