...
class PensionProjectionInputSerializer(serializers.Serializer):
    ...
    employee_contribution_percent = serializers.FloatField(min_value=0, max_value=100)
    employer_contribution_percent = serializers.FloatField(min_value=0, max_value=100)
    current_pot = serializers.FloatField(min_value=0, required=False, default=0.0)
